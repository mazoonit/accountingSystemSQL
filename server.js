...
var receiveReceipt=require('./routes/receiveReceipt.js');
var paymentReceipt=require('./routes/paymentReceipt.js');
...
app.use('/api/receiveReceipt',receiveReceipt);
app.use('/api/paymentReceipt',paymentReceipt);
